...
class StartActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        logo.setOnClickListener { Util.show(applicationContext, MainActivity::class.java) }
    ...
    private fun loadingAnimation() {
        ...
        duration = resources.getInteger(android.R.integer.config_longAnimTime)
        ...
        loading.animate()
            ...
            .setListener(object : AnimatorListenerAdapter() {
                ...
                private fun gotoAfterDelay() {
                    Handler().postDelayed(
                        {
                            Util.show(applicationContext, MainActivity::class.java)
                        },
                        duration.toLong()
                    )
                }
